...
class TestTemperatureConverter(TestCase):
    ...
    def testTryConvert(
        ...
        converter = TemperatureConverter(
            UnitPreprocessor(),
            self._mockConfig(primaryUnitId),
        )
    ...
    def _mockConfig(self, primaryUnitId: str) -> Configuration:
        def getSideEffect(configId):
            if configId == ConfigId.Converter_Temperature_Enabled: return True
            if configId == ConfigId.Converter_Temperature_PrimaryUnit: return primaryUnitId
