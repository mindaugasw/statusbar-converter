...
class TestDistanceConverter(AbstractConversionManagerTest):
    @parameterized.expand(
        [
            ('To mm', 'metric', '0.3 in', True, '0.3 in', '7.62 mm'),
            ('To cm', 'metric', '30 inches', True, '30 in', '76.2 cm'),
            ('To m', 'metric', '5.5 ft', True, '5.5 ft', '1.68 m'),
            ('Many m', 'metric', '3277.56 feet', True, '3278 ft', '999 m'),
            ('From yd', 'metric', '100 yd', True, '100 yd', '91.4 m'),
            ('To km', 'metric', '62 mi', True, '62 mi', '99.8 km'),
            ('To in', 'imperial', '5 cms', True, '5 cm', '1.97 in'),
            ('From dm', 'imperial', '5 dm', True, '5 dm', '1.64 ft'),
            ('To ft', 'imperial', '1.85 m', True, '1.85 m', '6.07 ft'),
            ('To mi', 'imperial', '100 km', True, '100 km', '62.1 mi'),
            ('Almost zero', 'imperial', '0.3 mm', True, '0.3 mm', '0.012 in'),
            ('Lots of small unit', 'imperial', '123456 mm', True, '123456 mm', '405 ft'),
            ('Little of big', 'metric', '0.000001 mi', True, '0 mi', '1.61 mm'),
            ...
            ('Compound ft 3', 'metric', "5'6 in", True, '5 ft', '1.52 m'),
            ('Compound ft 4', 'metric', '7 ft8in', True, '7 ft', '2.13 m'),
    ...
    def testDistanceConverter(
        ...
        text: str,
        expectSuccess: bool,
        expectFrom: str | None = None,
        expectTo: str | None = None,
    ) -> None:
        configOverrides = [
            (
