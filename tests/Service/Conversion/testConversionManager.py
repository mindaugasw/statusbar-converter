...
class TestConversionManager(AbstractConversionManagerTest):
    @parameterized.expand([
        ...
        ('Distance converter', '15 ft', True, '15 ft', '4.57 m'),
        ('Volume converter', '15 floz', True, '15 fl oz', '507 ml'),
        ...
        ('Letter case - uppercase', '5.5 FT', True, '5.5 ft', '1.68 m'),
        ('Letter case - different', '5.5 fT', True, '5.5 ft', '1.68 m'),
    ])
